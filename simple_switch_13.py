...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        self.macsOfSwitch1 = self.getMacsOfSwitch("1")
    ...
    #def installRoutes(self,ipToLoadBalance):
        

    def getMacsOfSwitch(self, dpid):
    ...
    def _packet_in_handler(self, ev):
        ...
        """
        ##testing
        if in_port == 1 and not(src in self.macsOfSwitch.values()) :
            self.mach1 = src
            self.logger.info(src)
        elif in_port == 2 and not(src in self.macsOfSwitch.values()) :
            self.mach2 = src
            self.logger.info(src)

        if self.mach1!="" and self.mach2!="" and not(self.routeInstalled):
            self.installRoutes("10.0.0.1")
        """
